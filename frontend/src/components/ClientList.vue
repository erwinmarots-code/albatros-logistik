  ...
  <div class="module-container">
    ...
    <div class="toolbar">
      ...
      <div class="search-wrapper">
        ...
        <input v-model="searchQuery" type="text" class="search-input" placeholder="Cari client..." />
      </div>
    </div>
    ...
    <p v-else class="empty-message">
      ...
      {{ searchQuery ? 'Tidak ada client yang cocok dengan pencarian.' : 'Belum ada data client.' }}
    </p>
  </div>
</template>
...
<style scoped>
/* ====== GAYA KONSISTEN (sama seperti DriverList) ====== */
.module-container {
  max-width: 1200px;
  margin: 0 auto;
}
